...
function ContractAddress() {
  ...
  return (
    <button
      type="button"
      onClick={handleCopy}
      className="group flex w-full flex-col gap-3 rounded-2xl border border-white/10 bg-white/5 px-4 py-3 text-left transition hover:border-flix-cyan/70 hover:bg-flix-cyan/10 sm:flex-row sm:items-center"
    >
      <div className="flex flex-1 flex-col gap-1 overflow-hidden">
        <span className="text-[10px] uppercase tracking-[0.5em] text-white/50">Token CA</span>
        <span
          className="font-mono text-xs tracking-[0.3em] text-white/90 break-all sm:tracking-[0.35em] sm:truncate"
      ...
      <div className="flex w-full items-center justify-between sm:w-auto sm:justify-end">
        ...
        <div className="ml-3 flex h-9 w-9 items-center justify-center rounded-xl border border-white/10 bg-white/5 text-white transition group-hover:border-flix-cyan/70 group-hover:bg-flix-cyan/20">
          <svg
            className="h-4 w-4"
            viewBox="0 0 24 24"
            fill="none"
