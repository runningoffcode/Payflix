...
| FIX_VIDEOS_RLS.sql | — | Replaced by `supabase/sql/videos_policies.sql` on 2025-11-11. | ✅ Removed |
...
| --- | --- | --- | --- | --- |
| fix-rls.ts | TS | Deprecated helper | Deleted 2025-11-11 (policies now live in `supabase/sql/videos_policies.sql`). |
