...
| USDC_PAYMENT_SETUP.md | Payment instructions; overlaps with session/auth docs. | ✅ Moved into `docs/infra/auth.md` (Appendix D). |
| X402_CORBITS_IMPLEMENTATION.md | Hackathon-specific doc. | ✅ Moved into `docs/infra/auth.md` (Appendix E). |
...
2. ✅ Move `CREATE_TABLES.sql` into `supabase/sql/`.
3. ✅ Delete `DISABLE_RLS.sql` (legacy quick toggle).
...
5. ✅ Relocate `USDC_PAYMENT_SETUP.md` & `X402_CORBITS_IMPLEMENTATION.md` into `docs/infra/auth.md` appendices.
